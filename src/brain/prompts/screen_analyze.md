...
- **The mouse coordinates**: the integer coordinates of the current mouse/cursor position which is represented by a red dot inside a white circle on the screenshot
